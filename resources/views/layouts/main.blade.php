            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mt-2 mt-lg-0">
                        ...
                        <li class="nav-item active">
                            @auth()
                                <a class="nav-link" href="{{ route('personal.main.index') }}">Personal Area<span class="sr-only">(current)</span></a>
                                @if(auth()->user()->role === 0)
                                    <li class="nav-item active">
                                        <a class="nav-link" href="{{ route('admin.main.index') }}">Admin pages<span class="sr-only">(current)</span></a>
                                    </li>
                                @endif
                            @endauth
                            @guest()
